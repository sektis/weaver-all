...
<div id="<?php echo $skin_id?>" class="h-100 position-relative">
    <style>
        ...
        <?php echo $skin_selector?> [class*=depth-swiper-]:not(.depth-swiper-1){position: absolute;top:100%;left:0;width: 100%;background-color: rgba(0, 0, 0, 0.8);padding: var(--wv-5) 0;opacity: 0;visibility: hidden;transition: opacity .4s;pointer-events: none}
