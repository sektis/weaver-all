...
<div class="hstack menu-tab-top" role="tablist">
    ...
    <a href="#" id="home-tab" class="active" data-bs-toggle="tab" data-bs-target="#0101-biz">운영 정보</a>
    <a href="#" id="home-tab" class="" data-bs-toggle="tab" data-bs-target="#0101-menu">메뉴 관리</a>
</div>
...
<div class="tab-content menu-tab-content " id="myTabContent">
    ...
    <div class="tab-pane fade show active" id="0101-biz" >
        <div class="tab-pane-inner  ">
            <div>
    ...
    <div class="tab-pane fade" id="0101-menu" >33</div>
</div>