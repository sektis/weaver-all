                ...
                <div class="vstack h-100 pt-[10px]" style="">
                        ...
                        <div class="wv-offcanvas-body col"   >
                            ...
                            <div class="col-box" style="row-gap: var(--wv-20)">
                                ...
                                <div class="mt-[20px]" >
                                    <?php echo $this->store->menu->render_part('images','form',array('menu_id'=>$row['id'])); ?>
                                </div>

                                <div class="fs-[12/17/-0.48/500/#97989C] mt-[20px] vstack" style="row-gap:var(--wv-8)">
                                    <div class="hstack align-items-start" style="gap:var(--wv-8)"><span class="fs-12em">·</span> <p>이미지는 순서대로 고객에게 보여집니다. 첫번째 이미지는 <br>대표 이미지입니다.</p></div>
                                    <div class="hstack align-items-start" style="gap:var(--wv-8)"><span class="fs-12em">·</span> <p>음식만 확대되어 어떤 음식인지 알 수 없는 이미지, 화질이 깨져 <br>음식 형태를 알아볼 수 없는 이미지, 메뉴와 관련 없는 이미지는 <br>삭제될 수 있습니다.</p></div>
                                    <div class="hstack align-items-start" style="gap:var(--wv-8)"><span class="fs-12em">·</span> <p>과도하게 연출되었거나 제공되는 것과 다를 경우 고객의 신뢰도가 <br>떨어질 수 있습니다.</p></div>
