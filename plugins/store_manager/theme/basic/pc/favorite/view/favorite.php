...
<div id="<?php echo $skin_id; ?>" class="wv-favorite-heart"  >
    ...
    $ajax_data['favorite']['store_wr_id']=$store_wr_id;
    $ajax_data['favorite']['mb_id']=$member['mb_id'];

    if ($row['wr_id']) { // 삭제
        $ajax_data['action']='delete_render';
    }
    ...
    >
        ...
        <label class=" "
            ...
            <input class="d-none view-toggle" type="checkbox" value="1" <?php echo $row['wr_id'] ? 'checked' : ''; ?>>
