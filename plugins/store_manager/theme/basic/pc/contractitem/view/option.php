...
<style>
    ...
    <?php echo $skin_selector?> .cont-box.active .status-box{background-color: #0d171b!important;color:#fff}
    <?php echo $skin_selector?> .cont-box.active{border-color: #0d171b!important; }
...
<div id="<?php echo $skin_id; ?>">
   <div class="cont-box <?php echo $cont['status']==1?'active':''; ?>">
       <div class="hstack justify-content-between align-items-start">
           ...
           <div>
               <p class="wv-flex-box status-box fs-[12/17/-0.48/500/] ff-pretendard " style="background-color: #f9f9f9"><?php echo $cont['status_text_option']?$cont['status_text_option']:'미이용 중'; ?></p>
       ...
       <div class="mt-[12px] fs-[12/17/-0.48/600/#97989C] w-full">
           ...
           <?php }else{ ?>
               <?php if($row['is_free'] and !$cont['id']){ ; ?>
