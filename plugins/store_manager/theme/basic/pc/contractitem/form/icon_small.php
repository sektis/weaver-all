...
<div class="border rounded-[4px]" style="padding:0.775em 0.75em">
    <p class=" ">서비스아이콘</p>
    <div class="wv-ps-file w-[80px] mx-auto ratio ratio-16x9 mt-[8.5px]" >
        <div>
            <input type="hidden" name="<?php echo $field_name; ?>[id]"      value="<?php echo $row['icon_small']['id']; ?>"    >
            <label class="wh-100 cursor-pointer d-flex-center text-center position-relative ">
                ...
                <?php if($row['icon_small']['path']){ ?>
                    <img src="<?php echo $row['icon_small']['path'] ?>"  alt="" class="wh-100 object-fit-contain">
                <?php } ?>
                    ...
                    <div class="absolute inset-0 vstack h-100 justify-content-center wv-ps-file-new <?php echo $row['icon_small']['path']?'d-none':''; ?>" style="row-gap:var(--wv-6)">
