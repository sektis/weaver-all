            ...
            <div class="vstack" style="row-gap: var(--wv-12)">
                <div class="border rounded-[4px] py-[12px] px-[16px] vstack  " style="row-gap: var(--wv-16)">
                    <div class="hstack gap-[8px] justify-content-between">
                        ...
                        <a href="<?php echo wv_page_url('0101'); ?>"><img src="<?php echo $wv_skin_url; ?>/img/ceo_main/arrow.png" class="w-[20px]" alt=""></a>
                    </div>
                    <div class=" vstack" style="row-gap: var(--wv-12)">
                        <div class="hstack align-items-start" style="gap:var(--wv-16)">
                            <div><img src="<?php echo $wv_skin_url; ?>/img/ceo_main/map.png" class="w-[38px]" alt=""></div>
                            <div>
                ...
                <div class="border rounded-[4px] py-[12px] px-[16px] vstack  " style="row-gap: var(--wv-16)">
                    <div class="hstack gap-[8px] justify-content-between">
                        ...
                        <a href="<?php echo wv_page_url('0201'); ?>"><img src="<?php echo $wv_skin_url; ?>/img/ceo_main/arrow.png" class="w-[20px]" alt=""></a>
                    </div>
                    <div class="  vstack" style="row-gap: var(--wv-12)">
