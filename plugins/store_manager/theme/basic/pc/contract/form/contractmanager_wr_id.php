...
<div>
    <div class="form-floating">
        <select name="contract[<?php echo $con; ?>][contractmanager_wr_id]" id="<?php echo $field_name; ?>" class="form-select required" required>
            <option value="">선택하세요.</option>
            <?php foreach ($list as $k=>$v){
                echo option_selected($v['wr_id'],$row[$column],$v['jm_mb_name']);
            } ?>
        </select>
