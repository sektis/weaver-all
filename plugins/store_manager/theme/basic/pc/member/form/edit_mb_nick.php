            ...
            <form name="fpartsupdate" action='<?php echo wv()->store_manager->made()->plugin_url ?>/ajax.php' method="post" class="h-100 wv-form-check" enctype="multipart/form-data">
                ...
                <div class="vstack h-100 pt-[10px]" style="">
                        ...
                        <div class=" ">
                            <div class="row align-items-center g-0">
                                ...
                                <div class="col-auto text-center">
                                    <p class="fs-[14/20/-0.56/600/#0D171B]">닉네임 변경</p>
                                </div>
                    ...
                    <div class="wv-offcanvas-body col">
                        <p class="fs-[16/22/-0.64/600/#0D171B]">새로운 닉네임을 입력해주세요.</p>
                        <div class="mt-[12px]">
                            <?php echo $this->store->member->render_part('mb_nick','form'); ?>
                        </div>
                    ...
                    <div class="container" style="background-color: #f9f9f9"><div class="m" style="height: 2px;background-color: #efefef"></div></div>
