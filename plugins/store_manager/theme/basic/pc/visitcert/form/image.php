...
<div class="border rounded-[4px]" style="padding:0.775em 0.75em">
    <div class="wv-ps-file  mx-auto ratio ratio-1x1 " >
        <div>
            ...
            <label class="wh-100 cursor-pointer d-flex-center text-center position-relative ">
                <input type="file" name="<?php echo $field_name; ?>" accept="image/*" class="d-none" required>
                ...
                <?php } ?>
                    <label class="position-absolute wv-ps-file-delete" style="">
                        <input type="checkbox" name="<?php echo $field_name; ?>" value="1" class="d-none"  >
                        <span></span>
                    </label>
