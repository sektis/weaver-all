...
<!-- 회원가입약관 동의 시작 { -->
<div class="social_register w-[800px] mx-auto md:w-full">
                ...
                <div class="vstack" style="padding: var(--wv-15) 0;row-gap: var(--wv-md-30,var(--wv-15))">
                    ...
                    <div>
                        <div class="form-floating">
                            ...
                            <input type="text" name="mb_email" value="<?php echo isset($user_email) ? $user_email : ''; ?>" id="reg_mb_email" required class="form-control email required" size="70" maxlength="100" placeholder="E-mail" >
                        ...
                        <div class="mt-[10px]"><?php echo $email_msg; ?></div>
                    </div>
                    ...
                    <div class="border p-[20px]">
                        <div class="fs-[25///700/]">혹시 기존 회원이신가요?</div>
                        <button type="button" class="connect-opener btn border mt-[10px]" data-remodal-target="modal">
                            기존 계정에 연결하기
