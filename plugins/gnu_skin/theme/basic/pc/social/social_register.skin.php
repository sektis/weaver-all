...
<div>
    ...
    <div class="login-sns sns-wrap-32 sns-wrap-over hstack p-[13px] " id="sns_register">
        <p class="col text-start">SNS 계정으로 가입</p>
        <div class="hstack sns-wrap col-auto" style="gap:var(--wv-10)">
