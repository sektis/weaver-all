...
<!-- 회원가입결과 시작 { -->
<div class="w-[800px] mx-auto md:w-full border text-center" style="padding: var(--wv-40) var(--wv-30)">


    <div class="vstack" style="padding: var(--wv-15) 0;row-gap: var(--wv-md-30,var(--wv-30))">
        <p class="fs-[30///700/]">
        ...
        <?php if (is_use_email_certify()) {  ?>
            <div class="vstack" style="gap:var(--wv-10)">
                <p class="result_txt">
