...
<div id="<?php echo $skin_id ?>" class="<?php echo $skin_class; ?> wv-skin-widget position-relative h-100 flex-nowrap bg-white" style="<?php echo isset($data['margin_top']) ? "margin-top::{$data['margin_top']};" : ''; ?>">
    <style>
        ...
        <?php echo $skin_selector?> .register-input-wrap{display: flex;flex-direction: column-reverse;row-gap: var(--wv-12)}

        <?php echo $skin_selector?> .register-input-wrap label{
                                        font-size: var(--wv-12);
                                        letter-spacing: -0.04em;
                                        font-weight: 600;
                                        color:#0D171B
                                    }
        <?php echo $skin_selector?> .register-input-wrap input{
                                        ...
                                        padding: 0 0 var(--wv-6) !important;
                                    }
        <?php echo $skin_selector?> #fregisterform #daum_juso_pagemb_zip{z-index: 50;position: absolute;background: #fff}
        <?php echo $skin_selector?> #fregisterform .col-form-label{width: var(--wv-120)}
        <?php echo $skin_selector?> #fregisterform .row{--bs-gutter-y: var(--wv-1)}
        ...
        @media (max-width: 991.98px) {
            <?php echo $skin_selector?>#fregisterform .col-form-label{width: 100vw;padding-top: var(--wv-md-3, revert-layer);padding-bottom: var(--wv-md-3, revert-layer)}
        }
    </style>
<!-- 회원정보 입력/수정 시작 { -->
            ...
            <div class="vstack h-100 ">
                ...
                <div class="wv-offcanvas-body col vstack">
                    <p class="fs-[24/32/-0.96/600/#0D171B]">
                        ...
                        ?>
                        <form id="fregisterform" name="fregisterform" action="<?php echo G5_BBS_URL ?>/register_form_update.php" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off" style="" class="h-100">
                            ...
                            <div class="vstack mt-[30px] h-100" style=";row-gap: var(--wv-30)">




                                <div class="register-input-wrap">
                                    <input type="password" name="mb_password" id="reg_mb_password" <?php echo $required ?> class="form-control <?php echo $required ?> wv-password-toggle" minlength="3" maxlength="20" placeholder="영문/숫자 조합 6~16자리" autocomplete="new-password">
                                    <label for="reg_mb_password" class="floatingInput">비밀번호</label>
                                </div>

                                <div class="register-input-wrap">
                                    <input type="password" name="mb_password_re" id="reg_mb_password_re" <?php echo $required ?> class="form-control <?php echo $required ?> wv-password-toggle" minlength="3" maxlength="20" placeholder="영문/숫자 조합 6~16자리" autocomplete="new-password">
                                ...
                                <div class="register-input-wrap">
                                    ...
                                    <input type="text" name="mb_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>" id="reg_mb_email" required class="form-control email required" size="70" maxlength="100" placeholder="이메일" >
