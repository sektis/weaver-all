               ...
               <div class="wv-offcanvas-body col vstack">
                   ...
                   <div class="mt-[40px] vstack" style="row-gap: var(--wv-30)">
                       <div class=""  >
                           ...
                           <input type="text" name="mb_hp" id="mb_hp" required class="mt-[12px] form-control fs-[16//-0.64/600/#0D171B] border-0 border-bottom " style="padding: 0 0 var(--wv-6)" size="20" maxLength="20" placeholder="영문/숫자 조합 6~16자리" autocomplete="new-password">
                       </div>

                       <div class=""  >
                           <label for="login_pw" class="fs-[12//-0.48/600/#0D171B]">새 비밀번호 확인<strong class="sound_only"> 필수</strong></label>
                           <input type="password" name="mb_birth" id="mb_birth" required class="mt-[12px] form-control fs-[16//-0.64/600/#0D171B] border-0 border-bottom  " style="padding: 0 0 var(--wv-6)" size="20" maxLength="8" minlength="8" placeholder="영문/숫자 조합 6~16자리" autocomplete="new-password">
                       </div>
                       <div class="mt-auto">
                           <button type="submit" class="w-full py-[14px] fs-[14//-0.56/700/#FFF] next-btn transition hover:bg-[#0d171b]" style="border:0;background-color: #cfcfcf;border-radius: var(--wv-4)">재설정 하기</button>
                       </div>
                   </div>
