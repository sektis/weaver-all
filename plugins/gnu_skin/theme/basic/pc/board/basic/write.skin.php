            ...
            <?php $i=0; ?>
                <div class="border p-3 rounded-3">
                    <div class="row align-items-center">
                        ...
                        <div class="col">
                            <input type="file" name="bf_file[<?php echo $i; ?>]" multiple data-index-range="1,<?php echo $board['bo_upload_count']; ?>" id="bf_file_<?php echo $i+1 ?>" title="파일첨부 <?php echo $i+1 ?> : 용량 <?php echo $upload_max_filesize ?> 이하만 업로드 가능" class="form-control form-control-sm">
