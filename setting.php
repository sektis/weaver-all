...
wv()->store_manager->make('','sub01_01',array('biz','store','location','contract','menu','dayoffs','tempdayoffs','plan'))->prune_columns();
wv()->store_manager->made()->rsync_mapping('sub01_01');
