...
wv()->store_manager->make('sub01_01','sub01_01',array('biz','store','location','menu','dayoffs','tempdayoffs','plan'));
wv()->store_manager->make('wv_cont_manager','wv_cont_manager',array('contractmanager'));
